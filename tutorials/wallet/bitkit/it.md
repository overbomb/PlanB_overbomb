...
il video tutorial qui sopra è una guida completa di 20 minuti a Bitkit Wallet
...
Come Bitcoin Wallet a tutti gli effetti, Bitkit include tutte le funzionalità che vi aspettate:


Pagamenti istantanei: Non dovrete più destreggiarvi tra i portafogli per le transazioni On-Chain e Lightning. Bitkit li fonde entrambi senza problemi.
...
Cronologia dettagliata delle transazioni: Assegnare contatti e taggare le transazioni per tenerle organizzate.
...
Niente banche. Nessun attrito.


![image](assets/en/02.webp)


## Guida per principianti a BitKit: Un tutorial passo dopo passo


### 1. Installare BitKit


Aprire l'App Store (iOS) o Google Play (Android).
...
BitKit crea automaticamente due account:


Risparmio: Bitcoin base Layer


Trasferimenti più grandi, più lenti e più sicuri


Spesa: Lightning Network
...
Toccare l'avatar in alto a sinistra.


Inserire un nome visualizzato e selezionare un'immagine del profilo.


BitKit mostra il vostro codice QR personale. Gli amici possono scansionarlo per aggiungervi.
...
Bitcoin Facts - curiosità in pillole per principianti.
...
### 10. Acquista con Bitcoin


BitKit si integra con Bitrefill per carte regalo, ricariche telefoniche e altro ancora.
...
Quick Pay conferma automaticamente le fatture Lightning al di sotto di un limite personalizzato (default 50 USD).


Andare su Impostazioni → Generali → Pagamenti rapidi.
...
Codice PIN - attivare in Impostazioni → Sicurezza e privacy e impostare un codice di sei cifre.


Biometria: attivare Face ID o lo sblocco tramite impronta digitale.


Auto-Lock - scegliere il timeout (ad esempio, 90 secondi di inattività).


Richiedere il PIN per i pagamenti: una maggiore tranquillità.



### 13. Gestione dei canali Lightning
...
Impostazioni → Avanzate → Connessioni Lightning


Toccate una connessione per vedere lo stato, i saldi e le tariffe.


Spostarsi su Chiudi connessione se si desidera chiudere la connessione e riportare i fondi ai risparmi.


Nota: per motivi normativi, la liquidità totale di BitKit è limitata a circa novecentonovanta euro di Bitcoin.
