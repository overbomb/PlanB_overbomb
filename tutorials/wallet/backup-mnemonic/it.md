...
Quando si crea un nuovo wallet Bitcoin, che sia software o hardware, si riceve una frase mnemonica composta da 12 o 24 parole. Questa frase è molto importante, in quanto è la fonte della derivazione di tutte le chiavi private che proteggono i tuoi Bitcoin. Deve essere salvaguardata con cura per garantire il recupero dei fondi in caso di rottura, furto o perdita del supporto del wallet.

In questo tutorial esploreremo le migliori pratiche per salvare la vostra frase mnemonica in modo sicuro, in modo da non perdere l'accesso ai tuoi bitcoin.

## Consapevolezza del rischio

Il mnemonico ti dà accesso completo e illimitato a tutti i toui bitcoin. Chiunque sia in possesso di questa frase può rubare i toui fondi, anche senza avere accesso fisico al supporto che ospita il tuo wallet.

Ciò significa, ad esempio, che se si utilizza un walet Bitcoin su un Ledger, chiunque abbia accesso alla tua frase mnemonica può rubare tutti i tuoi bitcoin, anche senza avere accesso al Ledger stesso. Ecco perché **non bisogna mai condividere la propria frase mnemonica**, in qualsiasi situazione.

Questa frase è l'unica informazione  che consente di ripristinare l'accesso ai bitcoin in caso di perdita, furto o danneggiamento del wallet. Riprendiamo l'esempio di Ledger: in caso di smarrimento del dispositivo, è possibile recuperare i propri fondi inserendo la frase mnemonica in un nuovo Ledger o in qualsiasi altro wallet compatibile, sia esso software o hardware.

È importante salvare questa frase con la massima cura e conservarla in un luogo sicuro, come illustreremo nelle sezioni seguenti.

**La tua frase mnemonica è esposta a due rischi principali: furto e smarrimento**

Il furto può avvenire in due modi principali:


- qualcuno ha avuto accesso fisico al tuo backup, ad esempio durante un furto con scasso o tramite un amico;
- hai condiviso volontariamente o involontariamente la tua frase con un'altra persona.

Per evitare il furto del backup della frase mnemonica, è importante conservarla in un luogo sicuro. Analizzeremo questo punto in dettaglio nelle sezioni successive.

Quando si tratta di tentativi di furto a distanza, ricordate sempre di non condividere mai la tua frase mnemonica, in qualsiasi situazione. I tentativi di phishing sono comuni: e-mail fraudolente, siti web che imitano quelli siti web di wallet ufficiali o richieste dirette attraverso vari canali di comunicazione. Se qualcuno ti chiede la tua frase mnemonica, si tratta di una truffa, anche in caso di emergenza! È comune che i ladri si fingano dipendenti del produttore del tuo hardware wallet, ma queste aziende non ti chiederanno mai la tua passphrase, in qualsiasi situazione. Fai molta attenzione a tutte le comunicazioni che ricevi, sia per e-mail, telefono, posta, social network o anche di persona.

Quando devi inserire la tua frase in un hardware wallet o in un software per ripristinare l'accesso al tuo wallet dopo un problema con il supporto iniziale, prendeti il tempo necessario per verificare l'autenticità e l'integrità dell'hardware o del software che stai utilizzando. Non farti prendere dal panico e procedi con metodo.

Inoltre, fai attenzione quando maneggi la tua frase mnemonica. Assicurati di non essere osservato da altre persone o da una telecamera.

Per quanto riguarda il rischio di perdita, questo può verificarsi per tre motivi principali: la perdita del supporto di backup, il suo degrado o un errata valutazione della sua importanza. Nelle sezioni seguenti vedremo come evitare o ridurre al minimo questi tre rischi.

## Il supporto

Per salvare la frase di recupero, è necessario scriverla su un supporto fisico, come carta o metallo. Non utilizzate mai un supporto digitale: non salvarla in un file di testo, non fotografarla e non memorizzarla in un password manager. Questi metodi aumentano notevolmente la superficie di attacco rispetto ai supporti fisici. La regola è quindi chiara: usare carta, cartone o metallo per salvare la frase.

Se scrivere la frase su un semplice foglio di carta è già una buona pratica, optare per un supporto in metallo, come l'acciaio inossidabile, offre maggiore sicurezza. Questo tipo di supporto protegge la frase mnemonica dai rischi di incendio, allagamento o crollo che possono colpire il luogo di conservazione.

Se sei alla ricerca di un'opzione economica per il backup della propria frase su metallo, [il metodo fai-da-te del "*SAFU Ninja*"](https://jlopp.github.io/metal-bitcoin-storage-reviews/reviews/safu-ninja/) è una soluzione eccellente. Tutto quello che dovete fare è comprare rondelle di metallo, una vite e un dado nei negozi. Poi si incidono le parole della frase su ogni rondella, avendo cura di numerarle, e si assemblano sulla vite con il dado. Questo metodo a basso costo offre già una buona resistenza.
...
Se si utilizza un portafoglio multisig o un portafoglio con script complessi che includono chiavi di recupero, come quelli offerti dal software Liana, è essenziale salvare gli **Output Script Descriptors**. Questi descrittori contengono tutte le informazioni necessarie, oltre alle parole di recupero, per riottenere l'accesso ai bitcoin.

È possibile arricchire il backup con informazioni aggiuntive relative al supporto del portafoglio. Ad esempio, annotare il codice PIN utilizzato per sbloccare il portafoglio hardware o le parole anti-phishing se si utilizza un COLDCARD.

![SEED](assets/fr/05.webp)

D'altra parte, se utilizzi una passphrase, assicurati di non scriverla sullo stesso supporto della tua frase mnemonica. Lo scopo della passphrase è quello di proteggere il portafoglio in caso di furto. Per saperne di più su come utilizzare una passphrase, dai un'occhiata a questo tutorial complementare:
